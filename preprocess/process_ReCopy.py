...
Path('../processed_data/fpc/').mkdir(parents=True, exist_ok=True)

train_save_path = Path('../processed_data/fpc/train.jsonl')
dev_save_path = {}
for key in dev_keys:
    dev_save_path[key] = Path('../processed_data/fpc/dev_{}.jsonl'.format(key))
test_save_path = {}
for key in test_keys:
    test_save_path[key] = Path('../processed_data/fpc/test_{}.jsonl'.format(key))
metadata_save_path = fspath(Path("../processed_data/fpc/metadata.pkl"))
