...
train_path = Path('LongLookupTables/LongLookupTables/data/train.tsv')

dev_path = {}
dev_path["normal"] = Path('LongLookupTables/LongLookupTables/data/validation.tsv')

test_path = {}
test_path["normal"] = Path('LongLookupTables/LongLookupTables/data/heldout_inputs.tsv')
test_path["long1"] = Path('LongLookupTables/LongLookupTables/data/longer_seen_1.tsv')
test_path["long2"] = Path('LongLookupTables/LongLookupTables/data/longer_seen_2.tsv')
test_path["long3"] = Path('LongLookupTables/LongLookupTables/data/longer_seen_3.tsv')
test_path["long4"] = Path('LongLookupTables/LongLookupTables/data/longer_seen_4.tsv')
test_path["long5"] = Path('LongLookupTables/LongLookupTables/data/longer_seen_5.tsv')

Path('../processed_data/llt/').mkdir(parents=True, exist_ok=True)

train_save_path = Path('../processed_data/llt/train.jsonl')
dev_save_path = {}
for key in dev_keys:
    dev_save_path[key] = Path('../processed_data/llt/dev_{}.jsonl'.format(key))
test_save_path = {}
for key in test_keys:
    test_save_path[key] = Path('../processed_data/llt/test_{}.jsonl'.format(key))
metadata_save_path = fspath(Path("../processed_data/llt/metadata.pkl"))
