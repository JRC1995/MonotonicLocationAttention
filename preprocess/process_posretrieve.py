...
Path('../processed_data/posretrieve/').mkdir(parents=True, exist_ok=True)

train_save_path = Path('../processed_data/posretrieve/train.jsonl')
dev_save_path = {}
for key in dev_keys:
    dev_save_path[key] = Path('../processed_data/posretrieve/dev_{}.jsonl'.format(key))
test_save_path = {}
for key in test_keys:
    test_save_path[key] = Path('../processed_data/posretrieve/test_{}.jsonl'.format(key))
metadata_save_path = fspath(Path("../processed_data/posretrieve/metadata.pkl"))
...
special_tags = ["<sos>", "<unk>", "<eos>", "<pad>", "n/a", ":", ";"]
