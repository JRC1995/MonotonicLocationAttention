...
Path('../processed_data/rpc/').mkdir(parents=True, exist_ok=True)

train_save_path = Path('../processed_data/rpc/train.jsonl')
dev_save_path = {}
for key in dev_keys:
    dev_save_path[key] = Path('../processed_data/rpc/dev_{}.jsonl'.format(key))
test_save_path = {}
for key in test_keys:
    test_save_path[key] = Path('../processed_data/rpc/test_{}.jsonl'.format(key))
metadata_save_path = fspath(Path("../processed_data/rpc/metadata.pkl"))
